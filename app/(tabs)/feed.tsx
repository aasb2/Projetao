  ...
  function renderContainer() {
    ...
    const toggleUserIcon = (userId: any) => {
      setUserIcons((prevIcons) => ({
        ...prevIcons,
        [userId]:
          prevIcons[userId] === "weight-lifter" ? "arm-flex" : "weight-lifter",
      }));
        ...
        >
          <View>
            ...
            >
              ...
              <TouchableOpacity
                onPress={() => console.log("Ver Todos Pressed")}
              >
            ...
            >
              ...
              >
                ...
                >
                  <TouchableOpacity
                    onPress={() =>
                      toggleUserIcon(item.id._key.path.segments.slice(-1)[0])
                    }
                  >
                    <MaterialCommunityIcons
                      name={
                        userIcons[item.id._key.path.segments.slice(-1)[0]] ||
                        "weight-lifter"
                      } // Use o ícone do estado ou 'weight-lifter' por padrão
                      size={20}
                      color={COLORS.white}
                    />
                  </TouchableOpacity>
